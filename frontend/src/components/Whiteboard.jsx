...
const Whiteboard = () => {
  ...
  const drawLine = (x0, y0, x1, y1, strokeColor, emit) => {
    ...
    // Make the eraser line a bit thicker so it's easier to erase!
    ...
    // Send the drawing coordinates to the server to broadcast to others
  ...
  return (
    <div className="flex flex-col items-center w-full h-full">
      <div className="mb-4 flex gap-4 bg-white/[0.05] p-3 rounded-2xl border border-white/10 items-center">
        ...
        <div className="w-px h-6 bg-white/20 mx-2"></div> {/* Divider */}
        
        {/* ERASER FIX: Matches the background color #0a0a0a exactly */}
        <button 
